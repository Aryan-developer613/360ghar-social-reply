...
export async function generateReply(
  ...
  options?: { voice_profile_id?: number | null; platform?: string | null; variants?: number; llm_model?: string }
) {
  ...
  if (options?.llm_model && options.llm_model !== "default") body.llm_model = options.llm_model;
